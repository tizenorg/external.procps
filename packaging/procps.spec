...
%changelog
* Tue Jan 11 2011 Jan Görig <jgorig@redhat.com> 3.2.8-15
- fixed procps-3.2.8-threads.patch (SIGABRT) (#670289)

* Tue Oct 19 2010 Jan Görig <jgorig@redhat.com> 3.2.8-14
- added devel package (Hicham HAOUARI <hicham.haouari@gmail.com>)

* Wed Sep 29 2010 jkeating - 3.2.8-13
- Rebuilt for gcc bug 634757

* Thu Sep 23 2010 Jan Görig <jgorig@redhat.com> 3.2.8-12
- merged selinux patches into procps-3.2.7-selinux.patch
- fixed #632236 - don't depend on constructor execution order

* Wed Sep 8 2010 Jan Görig <jgorig@redhat.com> 3.2.8-11
- fixed build with make 3.82

* Tue May 18 2010 Daniel Novotny <dnovotny@redhat.com> 3.2.8-10
- added patch for cgroup display (supress root group)
  thanks to Lennart Poettering (#593267)

* Tue Apr 06 2010 Daniel Novotny <dnovotny@redhat.com> 3.2.8-9
- fix #579741 - vmstat should use getopt() for parsing commandline

* Thu Apr 01 2010 Daniel Novotny <dnovotny@redhat.com> 3.2.8-8
- fix #578798 - vmstat -SM doesn't work but vmstat -S M does

* Mon Feb 08 2010 Daniel Novotny <dnovotny@redhat.com> 3.2.8-7
- fixed the last pmap(1) patch

* Fri Feb 05 2010 Daniel Novotny <dnovotny@redhat.com> 3.2.8-6
- fixed RSS values display of pmap(1)

* Mon Jan 11 2010 Daniel Novotny <dnovotny@redhat.com> 3.2.8-5
- fix #548711 -  [abrt] crash in procps-3.2.8-3.fc12

* Mon Nov 16 2009 Daniel Novotny <dnovotny@redhat.com> 3.2.8-4
- patch for enabling core file generation in ps (we don't trap the signal anymore)

* Wed Oct 07 2009 Daniel Novotny <dnovotny@redhat.com> 3.2.8-3
